/// <reference lib="dom" />
import { isBrowserEnvironment, mediaDevices as shimMediaDevices, RTCPeerConnection as RTCPeerConnectionCtor, } from '@openai/agents-realtime/_shims';
    ...
    async connect(options) {
        ...
        return new Promise(async (resolve, reject) => {
            try {
                ...
                let peerConnection = new RTCPeerConnectionCtor();
