...
exports.TwilioRealtimeTransportLayer = void 0;
 ...
 * ```
 */
class TwilioRealtimeTransportLayer extends realtime_1.OpenAIRealtimeWebSocket {
    #twilioWebSocket;
    #streamSid = null;
    #audioChunkCount = 0;
    #lastPlayedChunkCount = 0;
    #previousItemId = null;
    #logger = (0, agents_1.getLogger)('openai-agents:extensions:twilio');
    constructor(options) {
        super(options);
                ...
                switch (data.event) {
                    case 'media':
                        if (this.status === 'connected') {
                            this.sendAudio(realtime_1.utils.base64ToArrayBuffer(data.media.payload));
                        }
                        break;
                    case 'mark':
    ...
    _interrupt(_elapsedTime, cancelOngoingResponse = true) {
    ...
    _onAudio(audioEvent) {
        ...
        const audioDelta = {
            ...
            streamSid: this.#streamSid,
            media: {
                payload: realtime_1.utils.arrayBufferToBase64(audioEvent.data),
            },
        };
...
exports.TwilioRealtimeTransportLayer = TwilioRealtimeTransportLayer;
